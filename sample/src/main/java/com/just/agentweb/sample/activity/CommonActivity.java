    ...
    private void openFragment(int key) {
        ...
        switch (key) {
            ...
            case FLAG_GUIDE_DICTIONARY_VIDEO_FULL_SCREEN:
                ft.add(R.id.container_framelayout, mAgentWebFragment = AgentWebFragment.getInstance(mBundle = new Bundle()), AgentWebFragment.class.getName());
                mBundle.putString(AgentWebFragment.URL_KEY, "http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4");
                mBundle.putString(AgentWebFragment.URL_KEY, "https://media.w3.org/2010/05/sintel/trailer.mp4");
//                mBundle.putString(AgentWebFragment.URL_KEY, "https://v.youku.com/v_show/id_XMzU3NDIxMjgwOA==.html?spm=a2hww.20022069.m_215416.5~5~5~5!2~A");
